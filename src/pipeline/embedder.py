...
def chunk_legislative_item(
    ...
    @spec EMBED-CHUNK-010, EMBED-CHUNK-011, EMBED-CHUNK-012
    """
    text_parts = [title]
    if summary:
...
def generate_embeddings(texts: list[str]) -> list[list[float]]:
    ...
    @spec EMBED-GEN-001, EMBED-GEN-003, EMBED-GEN-004
    """
    config = get_config()
...
def run_embedding_pipeline(source_type: str | None = None) -> None:
    ...
    @spec EMBED-CHUNK-001, EMBED-CHUNK-010, EMBED-WRITE-001, EMBED-WRITE-002
    """
